...
public class RefreshTestView extends LinearLayout implements OnTouchListener {
	 ...
	 * @param attrs
	 */
	public RefreshTestView(Context context, AttributeSet attrs) {
		super(context, attrs);
...
//		System.out.println(lastUpdateTime+"lastUpdateTime!!!!!!!!!!!!!!!!!!!!"+(lastUpdateTime==-1));
		if(showUpdateTime){
